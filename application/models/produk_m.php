...
//            return null;
	...
	$string_query           = "select DISTINCT(a.ARTICLE_CODE),a.PLU,a.ARTICLE_DESC,STOCK_QTY,BOOK_QTY, CONFIRM_QTY,SALES_UNIT_PRICE from DC_STOCK_MASTER a,MS_MASTER b, STORE_SALES_MASTER c
				    Where a.SUBCLASS = b.MS_CHILD
				    AND a.ARTICLE_CODE = c.ARTICLE_CODE
				    AND a.DC_SITE_CODE = '$dc_site_code'
				    AND c.STORE_SITE_CODE = $store_site_code
