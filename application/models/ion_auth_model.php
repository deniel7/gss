...
class Ion_auth_model extends CI_Model
{
	...
	public function reset_password($identity, $new) {
		...
		$query = $this->db->select('id_user, password, salt')
		...
		$result = $query->row();
		//RUBAH jadi MD5 buat password user ktika ganti di reset password email
	...
	public function users($groups = NULL)
	{
		...
		//default selects
                //RUBAH id menjadi id_user
		$this->db->select(array(
		    $this->tables['users'].'.*', 
		    $this->tables['users'].'.id_user as id', 
		    $this->tables['users'].'.id_user as user_id'
		));
