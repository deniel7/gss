 ...
 */
$config['site_title']           = "YOGYA ECommerce"; 		// Site Title, example.com
$config['admin_email']          = "support@toserbayogya.com"; 	// Admin Email, admin@example.com
