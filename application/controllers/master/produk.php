...
//        $this->db->where('default',1);
	...
	if($data['search_plu'] !=0 && $data['search_kat'] == 151 && $data['search_name'] == NULL)
	{
	...
	}else if($data['search_plu'] ==0 && $data['search_kat'] != 151 && $data['search_name'] == NULL){
...
//           if(($query->num_rows() > 0)){
//	    
//	    $this->db->like('CONCAT(plu)', $data['search_plu']);
//	    $this->db->like('CONCAT(id_kategori)', $data['search_kat']);
//	    
//	    //echo $data['search_plu'];
//	    //echo "<br/>";
//	    //echo $data['search_kat'];
...
//	   }else{
	...
	//Pagination init
        $pagination['base_url'] 		= base_url().'/admin/produk/search/';
