...
<h3 class="tit">Kategori Produk</h3>
	<table>
		<tr>
		    <th>Nama Kategori</th>
            <th>Kode</th>
        ...
        <?php $i=0; foreach ($kategori as $key => $val): ?>
		<tr <?php echo $i%2 == 0 ? 'class="bg"' : '';  ?>>
		 ...
		 |
		<?php echo anchor(uri_string().'/hapus/'.$val['id_kategori'],'Hapus',array('onclick'=>"return confirm('Yakin akan menghapus kategori ini?')")) ?>
	    </td>
		</tr>
        <?php $i++; endforeach; ?>
    </table>
