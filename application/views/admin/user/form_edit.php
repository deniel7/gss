...
<?php else: ?>
    ...
    <?php
				...
				if($list_cab_sel->result() != NULL){
				foreach($list_cab_sel->result() as $cab_sel):
				//echo $cab_sel->kode_cabang;
				$a = $cab_sel->kode_cabang;
    ...
    <?php echo form_dropdown('cabang',$list_cab, $a); ?>
