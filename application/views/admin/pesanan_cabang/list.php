...
<div id="search_container">
	<?php
		...
		echo form_open('admin/pesanan_cabang/search');
	?>
			<span>
				<?php
					$data_search = array(
...
<?php if($pesanan!= array()): ?>
	<table>
		...
		<tr>
		    ...
		    <td><?php echo anchor('admin/pesanan_cabang/detail/'.$item->id_order, 'Detail', 'class="active" id="detail"') //echo anchor(uri_string().'/detail/'.$item->id_order, 'Detail', 'class="active" id="detail"') ?></td>
		</tr>
        <?php endforeach; ?>
