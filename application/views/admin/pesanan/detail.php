...
echo form_label('Ditangani oleh cabang :');
echo form_dropdown('cab', $list_cab);

//echo $cek_k;
echo "<b>Pastikan pembeli sudah melakukan Pembayaran dan sudah melakukan Konfirmasi.</b>";
//$select = array('-Pilih-','Belum','Sudah');
...
//}else{
//    echo "<p style='color:red'>Konfirmasi pembayaran belum dilakukan!</p>";
//}
