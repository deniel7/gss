...
echo form_label('PLU');
echo form_input('plu',@$plu,'class="input-text"');
echo form_label('Nama Produk');
echo form_input('nama_produk',@$nama_produk,'class="input-text"');
echo form_label('Top Sales');
?>

<input type="checkbox" name="topsales" class="input-text" value="1"<?php if (@$topsales=='1') echo 'checked="checked"'; ?> />

<?php
	echo '</div><div class="col-right">';
	echo form_label('Stok');
	echo form_input(array('name' => 'stok', 'readonly' => 'readonly'),@$stok,'class="input-text"');
	...
	echo form_input(array('name' => 'harga_baru', 'readonly' => 'readonly'),@$harga_baru,'class="input-text"');
	echo '</div><div class="clear"></div>';
	echo form_fieldset_close();
